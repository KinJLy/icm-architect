...
| `02_Reconcile` | match imports + receipts against the ledger, flag diffs | 01's output, `receipts/`, `ledger-0259.md` and `ledger-1844.md` | `output/{period}-reconciliation.md` | resolve every flagged discrepancy before it's posted |
| `03_Ledger` | post reconciled entries; the running record | 02's approved output | `ledger-0259.md` and `ledger-1844.md` (appended) | spot-check balances match the bank statement |
| `04_Report` | turn the ledger as-of-date into a board report | `ledger-0259.md` and `ledger-1844.md`, `_shared/*` | `output/{period}-board-report.md` | read it before it goes to the board |

Factory (stable, every run): `_shared/treasurer-principles.md`, `_shared/chart-of-accounts.md`.
Product (new each run): `01_Import/inbox/`, `02_Reconcile/output/`, `04_Report/output/`; `ledger-0259.md` and `ledger-1844.md` accumulate rather than resetting.
